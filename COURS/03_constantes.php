...
<body>
    ...
    <div class="topnav">
       ...
       <?php
        echo '<p>On utilise la methode define() pour creer une constante.Elle prend deux arguments/p>';
        ...
        echo __DIR__."<br>";  //Affichen le nom du chemin complet du dossier

        echo __FILE__."<br>";//Affichen le nom du chemin complet du fichier
