...
// echo 'le mot est :'$mot'';
echo"<br>";
// !!!!  On ne peut pas integrer les variables DANS les quotes simples
echo 'le mot est :'.$mot.'!! Et la ca marche car j ai sorti ma variable!!<br>';
...
echo "Bonjour mon p'tit $nom , bienvenue chez nous!<br>";
...
echo $citation.=" surtout quand on code en PHP!<br>";
?>
